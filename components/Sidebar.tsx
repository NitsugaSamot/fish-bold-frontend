...
const Sidebar = () => {
  ...
  const { auth, closeSessionAuth, loading } = authContext
    ...
    : { auth: null, closeSessionAuth: () => {}, loading: true };
  ...
  if (loading) {
    return <p>Cargando...</p>; // Puedes mostrar un spinner u otra interfaz de carga
  }
...
// //   const { auth, closeSessionAuth } = useAuth() as AuthData;
